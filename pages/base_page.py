...
class BasePage():
    ...
    # метод проверки что элемент на странице пропал
    ...
    # метод для перехода на страницу авториазции
    ...
    # метод проверки наличия ссылки авторизации на страницу
    def should_be_login_link(self):
        assert self.is_element_present(*BasePageLocators.LOGIN_LINK), "Login link is not presented"

    # метод для перехода в  корзину
    def basket_open(self):
        open_basket = self.browser.find_element(*BasketPageLocators.LOOK_BASKET)
        open_basket.click()
